        ...
        smf_sess_t *sess, n14_message_transfer_param_t *param)
{
    ...
    if (param->n2smbuf) {
        ...
        switch (param->state) {
        case N14_UE_REQUESTED_SESSION_ESTABLISHMENT:
        case N14_NETWORK_TRIGGERED_SERVICE_REQUEST:
            n2InfoContent.ngap_ie_type = OpenAPI_ngap_ie_type_PDU_RES_SETUP_REQ;
            break;
        case N14_NETWORK_REQUESTED_SESSION_MODIFICATION:
        case N14_NETWORK_REQUESTED_QOS_FLOW_MODIFICATION:
            n2InfoContent.ngap_ie_type = OpenAPI_ngap_ie_type_PDU_RES_MOD_REQ;
            break;
        case N14_NETWORK_REQUESTED_SESSION_RELEASE:
        case N14_ERROR_INDICATION_RECEIVED_FROM_5G_AN:
